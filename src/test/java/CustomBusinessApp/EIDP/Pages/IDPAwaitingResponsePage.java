...
public class IDPAwaitingResponsePage extends CommonUtils {
	...
	//*[@id='primaryMentorsawaitingResponseTable']/tbody/tr
	...
	public void clickOnProceedOfTrainee() {
		String xpath = "//table[@id='primaryMentorsawaitingResponseTable']//tbody//tr//td//a[text()='" + SharedData.traineeName +"']//ancestor::tr//td//img";
	...
	public void selecTraineeName(String str)  {
		CommonUtils.waitForVisibility(IDPHeader);
		 ...
		 for(int i=0;i<=sizeofTrainees;i++) {
			String TraineeName= WebDriverUtils.getWebDriver().findElements(By.xpath("//td[@class='sorting_1']/a")).get(i).getText();
			if(TraineeName.equalsIgnoreCase(str)){
				WebDriverUtils.getWebDriver().findElements(By.xpath("//td[@class='sorting_1']/a/following::td/a[@data-original-title='Proceed']")).get(i).click();
			}
		 }
	...
	public void validtingFieldsInaRow() throws InterruptedException {
		...
		for(int i=1;i<sizeofrows;i++) {
            ...
            WebDriverUtils.getWebDriver().findElement(By.xpath("//*[@id='primaryMentorsawaitingResponseTable']/tbody/tr["+i+"]/td[28]/a")).click();
...
//		}
	...
	public void projectInfoNoRevision() throws InterruptedException {
		...
		//String str=WebDriverUtils.getWebDriver().findElement(By.xpath("//input[@id='revisionRadioButtonNo']")).getAttribute("checked");
		 ...
		 CommonUtils.waitForVisibility(WebDriverUtils.getWebDriver().findElement(By.xpath("//textarea[@id='reviewText1']")));
		 WebDriverUtils.getWebDriver().findElement(By.xpath("//textarea[@id='reviewText1']")).sendKeys("No revision");
